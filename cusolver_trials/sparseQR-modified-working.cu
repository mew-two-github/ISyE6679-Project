...
//    const int m = 3;
//    const int nnzA = 9  ;
//    const std::vector<int> csrRowPtrA = {0, 3, 6, 9 };
//    const std::vector<int> csrColIndA = {0,1,2,0,1,2,0,1,2};
//    const std::vector<double> csrValA = {1,2,3,4,5,6,7,8,9};
//   const std::vector<double> b = {1.0, 1.0, 1.0};
    
    const int m = 3;
    const int nnzA = 9  ;
    const std::vector<int> csrRowPtrA = {1, 4, 7, 10 };
    const std::vector<int> csrColIndA = {1,2,3,1,2,3,1,2,3};
    const std::vector<double> csrValA = {1,2,3,4,5,6,7,8,9};
    const std::vector<double> b = {1.0, 1.0, 1.0};
